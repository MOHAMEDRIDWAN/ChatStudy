...
while True:
    ...
    s.send("acknowledgement recieved from the user".encode())

```

## OUTPUT
### CLIENT:
<img width="959" alt="image" src="https://github.com/MOHAMEDRIDWAN/ChatStudy/assets/146993368/7e3d9fa2-c3ab-49b4-bfe7-62d342cc6e68">


### SERVER:
<img width="959" alt="image" src="https://github.com/MOHAMEDRIDWAN/ChatStudy/assets/146993368/b39f2658-707b-4c7a-8012-d06fb2093a49">
